...
class BlackjackGame:
    ...
    def init_game(self):
        ...
        if self.play_counter%4==0:
            self.recorded_card = []
        self.play_counter += 1

        self.dealer = Dealer(self.np_random,self.play_counter, self.num_decks)
    ...
    def step(self, action):
        ...
        for i in range(self.num_players):
            if i != self.game_pointer:
                next_state['record_card'] = next_state['record_card'] + next_state['player' + str(i) + ' hand']
    ...
    def get_state(self, player_id):
        ...
        state['record_card'] = state['record_card'] + ['old_cards:'] + self.recorded_card
