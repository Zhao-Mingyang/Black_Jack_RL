...
def draw_hand(the_deck):
    return [the_deck.pop()[0], the_deck.pop()[0]]
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        if action:  # hit: add a card to players hand and return
            self.player.append(self.the_deck.pop()[0])
            ...
            while sum_hand(self.dealer) < 17:
                self.dealer.append(self.the_deck.pop()[0])
    ...
    def reset(
        ...
        self.dealer = draw_hand(self.the_deck)
        self.player = draw_hand(self.the_deck)
